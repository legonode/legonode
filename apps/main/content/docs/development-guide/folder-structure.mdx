...
description: Folder structure, file naming conventions, and how Legonode maps files to routes, middleware, and events.
---

# Folder Structure

This guide explains how Legonode organizes your `appDir` directory: which folders and file names are special, how URL paths are derived, and how to name files for routes, middleware, and events.
...
Supported extensions for routes and middleware: `.ts`, `.js`, `.mts`, `.mjs`. Use the same extensions for event files.
