...
/** Hex palette per theme (matches Legonode light/dark). Using static hex so colors are reliable. */
const THEME_PALETTE = {
  light: {
    foreground: '#fafafa',
    muted: '#71717a',
...
export interface LottieSVGProps {
  /** Path to Lottie JSON in public (e.g. /legonode-logo-animation.json). */
  src: string;
  className?: string;
