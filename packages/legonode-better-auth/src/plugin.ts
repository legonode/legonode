import type { Context, LegonodeContext, LegonodePlugin } from "legonode";
...
export type BetterAuthPluginOptions = {
   ...
   * (Requires you to augment LegonodeContext types in your app if you want full typing.)
   */
...
export function BetterAuthPlugin(options: BetterAuthPluginOptions): LegonodePlugin {
  return {
    name: "@legonode/better-auth",
    async onRequest(ctx: LegonodeContext) {
